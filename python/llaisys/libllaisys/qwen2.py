...
# 镜像 include/llaisys/models/qwen2.h 的 LlaisysQwen2Meta（字段顺序必须一致）
...
# 镜像 LlaisysQwen2Weights：逐层字段是 llaisysTensor_t* → POINTER，支持下标索引
...
llaisysQwen2Model_t = c_void_p  # opaque 模型指针
